    ...
    return (
        <>
            <div className="bg-indigo-50">
                <div className="xl:px-20 md:px-20 sm:px-6 px-4 md:py-18 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                         <p tabIndex={0} className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800 items-center justify-center">
                           Register
                        </p>
                        ...
                        <div className="mt-6 w-full py-0 pb-2">
                        ...
                        <div className="mt-6 w-full py-0 mb-0">
                            <label htmlFor="myInput" className="text-sm font-medium leading-none text-gray-800">
                                {" "}
                                Confirm Password{" "}
                            </label>
